...
<script>
	...
	$(document).ready(function() {
		...
		$("input[type=file]").change(function () {
			...
			$('#counter').html("첨부파일 갯수:" + files.length + " / 최대 5개"); //글자수 실시간 카운팅
	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
				<form id="postInsertForm"class="form-horizontal" role="form" action="${cp}/insertPost" method="post" enctype="multipart/form-data">
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							...
							<input type="hidden" value="${post_gn}" name="post_gn">
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							...
							<span style="color:#aaa;" id="counter">첨부파일 갯수 : 0 / 최대 5개</span>
						</div>
					</div>
